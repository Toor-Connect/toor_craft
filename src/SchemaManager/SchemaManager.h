...
public:
    ...
    EntitySchema *getProfileSchema(const std::string &profileName) const;
    std::vector<std::string> getProfileSchemaNames() const;
    bool profileExists(const std::string &profileName) const;
    std::vector<std::string> getEntitySchemaNames() const;
    EntitySchema *getEntitySchema(const std::string &entityName) const;
    void clear();
